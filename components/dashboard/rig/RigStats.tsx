...
function Stat({ label, value, warn }: { label: string; value: string; warn?: boolean }) {
  return (
    <div className={warn ? "rounded-xl border border-warn/40 bg-warn/10 p-4" : "submerged-card p-4"}>
...
export function RigStats({ rig }: { rig: ReturnType<typeof useRigTelemetry> }) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="submerged-card flex flex-wrap justify-between gap-2 p-4">
